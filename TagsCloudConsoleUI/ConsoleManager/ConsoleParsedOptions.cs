...
{
    public class ConsoleParsedOptions
    {
        ...
        [Option("palette", Default = "#8cff8a #e88787 #8797e8 #df95ed", 
        ...
        [Option("sizemult", Default = 10, Required = false, HelpText = "Font size multiplier")]
