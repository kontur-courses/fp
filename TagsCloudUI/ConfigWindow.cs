...
namespace TagsCloudUI
{
    public partial class ConfigWindow : Form
    {
        ...
        private void AcceptSettings()
        {
            ...
            wordsConfig.LayouterName = BindGroupBoxControls(layouterBox).FirstOrDefault();
            wordsConfig.TagGeneratorName = BindGroupBoxControls(tagGeneratorsBox).FirstOrDefault();
        ...
        {
            MessageBox.Show($"An error has occurred:\n{error}", "Error", MessageBoxButtons.OK);
