...
{
    [TestFixture]
    public class WordsMistakesCorrector_Should
    {
        private IGrammarDictionary grammarDictionary;
        private readonly Dictionary<string, string> correctForms = new Dictionary<string, string> { { "mistak", "mistake" }, { "incorrect", "correct" } };
