...
namespace TagsCloudContainerTests.CircularCloudLayouter_Tests
{
    ...
    public class CircularCloudLayouter_Should
    {
        ...
        public void PutNextRectangle_ReturnsRectangle_WhichContainsStartPoint()
        {
            ...
            nextRectangle.GetValueOrThrow().Contains(basePoints.First()).Should().BeTrue();
        }
        ...
        public void PutNextRectangle_ReturnsNonIntersectingRectangle_WhenThereAreFewRectangles()
        {
            ...
            AssertThatRectanglesDoNotIntersect(rectangles.GetValues().ToList());
        }
        ...
        [Test]
        public void PutNextRectangle_DoesNotReturnsRectangles_WhichDoNotSatisfyFilter()
        {
            ...
            rectangle.GetValueOrThrow().Contains(points.First()).Should().BeFalse();
        }
