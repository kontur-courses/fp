...
namespace TagsCloudContainerTests
{
    ...
    public class CircularCloudLayouterTests
    {
        ...
        {
            Action action = () => cloud.PutNextCloudItem(word, new Size(width, height), font).GetValueOrThrow();
        ...
        {
            var cloudItem = cloud.PutNextCloudItem(word, size, font).GetValueOrThrow();
        ...
        public void PutNextCloudItem_ShouldNotIntersectWithOtherItems_On(int alreadyExist)
        {
            ...
            var rectangle = cloud.PutNextCloudItem(word, size, font).GetValueOrThrow().Rectangle;
