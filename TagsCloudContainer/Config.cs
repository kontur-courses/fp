...
namespace TagsCloudContainer
{
    public class Config
    {
        ...
        private static string[] acceptableFormats = new string[]{ "memorybmp", "bmp", "emf", "wmf", "gif", "jpeg", "png", 
            "tiff", "exif", "icon" };
        private static string[] acceptableParts = new string[] { "A", "ADV", "ADVPRO", "ANUM", "APRO", "COM", "CONJ", "INTJ",
        ...
        public static Result<Config> FromArguments(string inpPath, string outPath, int width, int height, string color, 
            string font, bool compFlag, string fileFormat, IEnumerable<string> excluded)
        {
            ...
            foreach (var part in acceptableParts)
            {
                if(!acceptableFormats.Contains(part.ToUpper()))
                {
