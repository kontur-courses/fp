...
namespace TagsCloudConsoleVersion
{
    public class Options
    {
        ...
        [Option('s', "save", Required = true, HelpText = "Имя сохраняемого файла(расширение указывать не надо)")]
        public string PathSaveFile { get; set; }

        [Option("squeezed", Default = false, HelpText = "Использовать сжатый алгоритм, дольше по времени")]
