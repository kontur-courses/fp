...
namespace TagsCloudLibraryTests
{
    ...
    class MyStemProcessTests
    {
        ...
        public void StreamToWords_ExtractsInitialForms()
        {
            ...
            var words = myStemProcess.StreamToWords(inputStream).Value.ToList();
        ...
        public void StreamToWords_NoWords_Succeeds()
        {
            ...
            var words = myStemProcess.StreamToWords(inputStream).Value;
        ...
        public void GetWordsWithGrammar_DetectsPartsOfSpeech()
        {
            ...
            var partsOfSpeech = myStemProcess.GetWordsWithGrammar(wordsList).Value
        ...
        public void GetWordsWithGrammar_StoresBothInputFormAndInitialForm()
        {
            ...
            var words = myStemProcess.GetWordsWithGrammar(wordsList).Value.ToList();
        ...
        public void GetWordsWithGrammar_NoWords_Succeeds()
        {
            ...
            var wordsWithGrammar = myStemProcess.GetWordsWithGrammar(wordsList).Value;
