...
namespace TagsCloudContainer
{
    public class ImageSettingsAction : IUIAction
    {
        ...
        private Dictionary<string, Color> colorSelector;
        private Dictionary<string, FontFamily> fontFamilySelector;
        private Dictionary<string, FontStyle> styleSelector;
        private Dictionary<string, ImageFormat> formatSelector;
