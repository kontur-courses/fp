...
namespace TagCloud
{
    public class Client : IClient
    {
        ...
        private HashSet<string> availableFontNames;
        ...
        public void Start(ICloudVisualization visualization)
        {
            ...
            config = new ClientConfig(availableFontNames,availablePaletteNames);
            ...
            while (!config.ToExit)
            {
                ...
                while (!config.ToExit && !config.ToCreateNewImage)
                {
                    ...
                    actionsDictionary[command].Perform(config, userSettings);
                }
            }
        }
