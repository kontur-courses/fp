...
namespace TagCloudContainer.Rectangles
{
    ...
    {
        public IEnumerable<Result<SizeTextRectangle>> GetRectangles(IEnumerable<ITag> fontTags)
        {
            ...
            foreach (var tag in fontTags)
            {
                ...
                yield return Result.Of(()=>new SizeTextRectangle(rectangle, tag.Word, font));
            }
        }
