...
namespace TagCloudGraphicalUserInterface.Settings
{
    public class PresetsSettings : IPresetsSettings
    {
        ...
        [DisplayName("Использовать .txt файл")] public bool txtReader { get; set; }

        [DisplayName("Фильтрация облака")] public bool Filtered { get; set; }

        [DisplayName("Только нижний регистр")] public bool ToLowerCase { get; set; }

        [DisplayName("Использовать палтиру")] public bool PaletteUse { get; set; }
