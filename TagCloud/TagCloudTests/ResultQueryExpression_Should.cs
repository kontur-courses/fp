...
namespace TagCloudTests
{
    ...
    public class ResultQueryExpression_Should
    {
        ...
        {
            var res = from i in "1358571172".ParseIntResult()
