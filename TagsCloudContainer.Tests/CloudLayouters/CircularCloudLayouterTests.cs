...
public class CircularCloudLayouterTests
{
    ...
    [Test]
    public void PutNextRectangle_ShouldFail_WhenSizeNotPositive()
    {
        var result = sut.PutNextRectangle(new Size(0, 0));
    ...
    public void PutNextRectangle_ShouldReturnRectangleWithGivenSize()
    {
        ...
        var rectangle = sut.PutNextRectangle(size).GetValueOrThrow();
    ...
    public void PutNextRectangle_ShouldReturnNotIntersectingRectangles()
    {
        ...
        var actualRectangles = sizes.Select(x => sut.PutNextRectangle(x))
    ...
    public void PutNextRectangle_ShouldCreateLayoutCloseToCircle()
    {
        ...
        var rectangles = sizes.Select(size => sut.PutNextRectangle(size))
            .Select(result => result.GetValueOrThrow())
            .ToList();
