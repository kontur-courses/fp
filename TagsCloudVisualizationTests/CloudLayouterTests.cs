...
{
    [TestFixture]
    internal class CloudLayouterTests
    {
        [SetUp]
        ...
        [Test]
        [TestCaseSource(nameof(TestCasesGeneratorFor_NextRectangleMustByFartherFromCenter))]
        ...
        public void RectanglesAreNotIntersectingAfterAdditionNew()
        {
            ...
            foreach (var rectangleSize in rectanglesSizes) cloudLayouter.PutNextRectangle(rectangleSize);
