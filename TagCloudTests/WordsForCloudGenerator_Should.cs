...
public class WordsForCloudGenerator_Should
{
    ...
    {
        wordsForCloudGenerator.Generate(new List<string> { "w", "w", "e", "e", "e", "c" }).Value.ToList()[0].Word
            .Should().Be("e");
    }
    ...
    {
        var wordForCloud = wordsForCloudGenerator.Generate(new List<string> { "w", "w", "e", "e", "e", "c" }).Value
            .ToList()[0];
