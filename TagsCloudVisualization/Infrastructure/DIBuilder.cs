...
namespace TagsCloudVisualization.Infrastructure
{
    public class DIBuilder
    {
        ...
        private IContainer BuildContainer()
        {
            ...
            builder.Register(c => new FontSettings(options.FontFamily, options.FontStyle, options.MaxFontSize)).AsSelf();
            builder.Register(c => new Palette(options.BackgroundColor, options.ForegroundColor)).AsSelf();
