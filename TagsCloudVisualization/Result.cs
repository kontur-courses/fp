...
public static class Result
{
    ...
    public static Result<TOutput> Then<TInput,TOutput>(this Result<TInput> input, Func<Result<TOutput>> continuation) =>
    ...
    public static Result<TInput> Validate<TInput>(this Result<TInput> input, Func<TInput, bool> validator,
        string errorMessage)
    {
        return input.Then(i => validator(i) ? Ok(i) : Fail<TInput>(errorMessage));
    }
