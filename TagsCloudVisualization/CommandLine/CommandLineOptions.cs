...
public class CommandLineOptions
{
    ...
    [Option("format", Default = "png", HelpText = "Extension file to save.")]
    ...
    [Option("width", Default = 2500, HelpText = "Image width")]
    public int ImageWidth { get; set; }

    [Option("height", Default = 2000, HelpText = "Image height")]
    public int ImageHeight { get; set; }

    [Option('b', "backgroundColor", Default = "White", HelpText = "Image background color.")]
    public string BackgroundColor { get; set; }

    [Option("color", Default = "Random", HelpText = "Color of the words. Capitalized")]
    ...
    [Option("maxFontSize", Default = 60, HelpText = "Maximum word font size")]
