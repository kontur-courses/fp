...
namespace TagsCloudCreatorGUI
{
    public partial class Form1 : Form
    {
        ...
        {
            if (creator.SetFontFamily(textBoxFontFamily.Text).IsSuccess)
        ...
        private void completeColor_Click_1(object sender, EventArgs e)
        {
            if (textBoxColor.Text != "")
                if (!creator.SetFontColor(textBoxColor.Text).IsSuccess)
        ...
        private void completeImageSize_Click(object sender, EventArgs e)
        {
            ...
            {
                int size;
                if (int.TryParse(textBoxImageSize.Text, out size) && creator.SetImageSize(size).IsSuccess)
                {
        ...
        private void completeImageFormat_Click(object sender, EventArgs e)
        {
            ...
            {
                if (!creator.SetImageFormat(textBoxImageFormat.Text).IsSuccess)
