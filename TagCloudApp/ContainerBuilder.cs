...
namespace TagCloudApp
{
    ...
    {
        public static Autofac.ContainerBuilder GetDefault(Configuration configuration)
        {
        ...
        private static void RegisterTextHandlers(Autofac.ContainerBuilder builder)
        {
        ...
        private static void RegisterTemplateHandlers(Autofac.ContainerBuilder builder)
        {
        ...
        private static void RegisterCloudLayouter(Autofac.ContainerBuilder builder)
        {
