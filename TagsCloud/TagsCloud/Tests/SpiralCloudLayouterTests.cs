...
namespace TagsCloud.Tests
{
    ...
    public class SpiralCloudLayouterTests
    {
        ...
        public void PutNextRectangle_ReturnsCenterRectangle_OnFirstPut(int width, int height)
        {
            ...
            cloud.PutNextRectangle(rectangleSize).Value.Location.Should().Be(expectedLocation);
        }
        ...
        {
            var rect1 = cloud.PutNextRectangle(new Size(4, 5)).Value;
            var rect2 = cloud.PutNextRectangle(new Size(8, 3)).Value;
        ...
        public void PutNextRectangle_ReturnsNotIntersectingRectangles_On100RandomSizes()
        {
            ...
            for (var i = 0; i < 100; i++)
            {
                ...
                var rectangle = cloud.PutNextRectangle(new Size(width, height)).Value;
        ...
        public void PutNextRectangle_PutsRectanglesInCircleShape()
        {
            ...
            for (var i = 0; i < 100; i++)
            {
                var rectangle = cloud.PutNextRectangle(new Size(random.Next(1, 11), random.Next(1, 11))).Value;
