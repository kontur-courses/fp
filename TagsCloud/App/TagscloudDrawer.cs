...
namespace TagsCloud.App
{
    public class TagsCloudDrawer : ITagsCloudDrawer
    {
        ...
        public Result<Image> GetTagsCloud(IEnumerable<Word> words)
        {
            ...
            return GetTagsFromWords(
                ...
                .Then(tags =>
                {
                    ...
                    return DrawTagsCloud(tags, imageCenter - layouterCenterDelta, image);
                });
        }
        ...
        public Result<Image> DrawTagsCloud(IEnumerable<Tag> tags, PointF center, Image image)
        {
            if (tags == null)
                return Result.Fail<Image>("Tags collection should not be null.");
            var graphics = Graphics.FromImage(image);
